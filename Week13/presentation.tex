...
\easyurl{Regel der Drei}{https://en.wikipedia.org/wiki/Rule_of_three_(C\%2B\%2B_programming)}
\end{frame}
...
\begin{itemize}
\item Für neue Datenstrukturen brauchen wir neue Operatorüberladungen.
\item Operatoren als Mitgliedsfunktionen
\item Operatoren als globale Überladungen
\item Implizite Typenumwandlung
\end{itemize}
\end{block}
...
\begin{frame}{Prüfungsvorbereitung}
\easyurl{Alte Prüfungen D-ITET}{http://lec.inf.ethz.ch/itet/informatik1/2017/}\hfill\easyurl{Alte Prüfungen D-PHYS}{http://lec.inf.ethz.ch/ifmp/2017/}
\end{frame}
